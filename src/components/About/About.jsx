...
export default function About() {
  return (
    <section id="about" className="min-h-[90vh] flex items-center justify-center bg-[var(--color-bg)] font-body px-6 sm:px-8 md:px-10 xl:px-20 py-16 sm:py-20">
      <motion.div
        ...
        viewport={{ once: true }}>
        <img src={tattooTeam} alt="Nuestro equipo" className="w-full max-w-md md:max-w-none md:w-1/2 rounded-lg shadow-lg border border-[var(--color-border)]" />
