  ...
  return (
    <footer className="bg-[var(--color-bg)] border-t border-[var(--color-border)] text-[var(--color-text-secondary)] font-body px-6 py-10">
      <motion.div
        ...
        viewport={{ once: true }}>
        <h2 className="text-[var(--color-text)] font-titulo text-2xl">
          TattooMS
        </h2>

        <div>
          <h4 className="text-sm mb-2 uppercase tracking-widest font-semibold text-[var(--color-text)]">
            Contacto
          </h4>
        ...
        <div>
          <h4 className="text-sm mb-2 uppercase tracking-widest font-semibold text-[var(--color-text)]"></h4>
